...
class Sacas extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.sacas.view', [
            'sacas' => Saca::latest()
    ...
    public function store()
    {
		...
		session()->flash('message', 'Saca Successfully created.');
    }

    public function edit($id)
    {
        $record = Saca::findOrFail($id);
    ...
    public function update()
    {
        ...
        if ($this->selected_id) {
			$record = Saca::find($this->selected_id);
            $record->update([ 
			'ejemplar_id' => $this-> ejemplar_id,
			'usuario_id' => $this-> usuario_id,
			'fecha_devolucion' => $this-> fecha_devolucion,
            ...
            $this->resetInput();
            $this->updateMode = false;
			session()->flash('message', 'Saca Successfully updated.');
        }
    }
